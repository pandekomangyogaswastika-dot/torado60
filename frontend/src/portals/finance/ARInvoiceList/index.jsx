...
import { InvoiceCreateDialog, CustomerCreateDialog, ReceiptDialog, InvoiceDetailDialog } from "../ARInvoiceDialogs";
...
export default function ARInvoiceList() {
  ...
  const handleSendInvoice = async (inv) => {
    if (!window.confirm(`Tandai invoice ${inv.invoice_no} sebagai terkirim?`)) return;
    try {
